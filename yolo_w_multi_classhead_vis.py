...
if __name__ == '__main__':
    ...
    # Log to wandb
    wandb.init(project="multi_class_val")
    ...
    weight_path = 'fashion_classification_l/best_model.pt'
    ...
    # Validation
    reverse_attribute_translation = {v: k for k, v in attribute_translation.items()}
    # Validation 결과 출력 및 시각화
    val_loss, metrics = validate_model_with_metrics(model, val_dataloader, compute_loss)
